...
import (
	...
	"github.com/projectbarks/goheadroom/core/internal/textutil"
)
...
func tryDetectDiff(text string) (DetectionResult, bool) {
	...
	return DetectionResult{
		...
		Confidence:  confidence,
		Metadata: map[string]interface{}{
			"header_matches": int(headerMatches),
			"change_lines":   int(changeMatches),
		},
	}, true
}
...
func tryDetectHTML(text string) (DetectionResult, bool) {
	...
	return DetectionResult{
		...
		Metadata: map[string]interface{}{
			...
			"structural_tags": int(structuralMatches),
		},
	}, true
}
...
func tryDetectSearch(text string) (DetectionResult, bool) {
	...
	return DetectionResult{
		...
		Confidence:  confidence,
		Metadata: map[string]interface{}{
			"matching_lines": int(matchingLines),
			"total_lines":    int(nonEmptyLines),
		},
	}, true
}
...
func tryDetectLog(text string) (DetectionResult, bool) {
	...
	return DetectionResult{
		...
		Confidence:  confidence,
		Metadata: map[string]interface{}{
			"pattern_matches": int(patternMatches),
			"error_matches":   int(errorMatches),
			"total_lines":     int(nonEmptyLines),
		},
	}, true
}
